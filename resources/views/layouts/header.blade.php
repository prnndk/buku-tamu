<nav class="navbar navbar-expand-lg fixed-top border-bottom border-body" style="-webkit-backdrop-filter: blur(8px);
  backdrop-filter: blur(8px); background-color: hsla(0, 0%, 95.3%, 0.75)">
